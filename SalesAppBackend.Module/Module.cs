...
namespace SalesAppBackend.Module {
    ...
    public sealed partial class SalesAppBackendModule : ModuleBase {
        static SalesAppBackendModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<SalesAppBackendDbContext>());
            // #endif 
        }
        public SalesAppBackendModule() {
            InitializeComponent();
        }
